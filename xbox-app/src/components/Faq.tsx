...
import { FaqQuestions } from '../pages/home/Home';
...
const Faq = ({value}: FaqProps) => {
    ...
    return (
        <div className="w-full overflow-hidden relative">
            <h1 className='text-6xl text-brand font-bold'>Perguntas <span className='text-white'>frequentes</span></h1>
                    ...
                    value?.map(i => (
                        <div key={i.id} className='p-2 w-full border-b border-dark15'>
                            ...
                            <div className='flex flex-row w-full justify-between'>
                                <p className='text-white text-3xl'>{i.question}</p>
